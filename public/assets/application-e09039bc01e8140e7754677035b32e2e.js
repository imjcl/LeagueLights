...
(function() {
  $('.champion-name').on('mouseenter', 'a', function() {
    return $(this).parent().parent().animate({
      height: "350px"
    });
  });

  $('.champion-name').on('mouseleave', 'a', function() {
    return $(this).parent().parent().animate({
      height: "175px"
    });
  });
...
(function() {
  $(function() {
    return $('.highlight-reel').slick({
      dots: false,
      arrows: true,
      appendArrows: $('.highlight-nav'),
      infinite: true,
      speed: 300,
      slidesToShow: 3,
      touchMove: false,
...
(function() {
  $(function() {
    var id, params, videos, _i, _len, _results;
    videos = [];
    $('div.player').each(function() {
      return videos.push($(this).attr('id'));
    });
    params = {
    ...
    for (_i = 0, _len = videos.length; _i < _len; _i++) {
      id = videos[_i];
      _results.push(swfobject.embedSWF("http://www.youtube.com/v/" + id + "?enablejsapi=1&playerapiid=ytplayer&version=3", id, "425", "356", "8", null, null, params, id));
    }
    return _results;
  });
